...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success("Votre message a bien été envoyé ! Nous vous recontacterons bientôt.");
      setFormData({
        name: "",
        email: "",
        phone: "",
              ...
              <div className="bg-white rounded-3xl p-8 md:p-10 shadow-xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-[#C9A55C] hover:bg-[#B8944B] text-white h-14 rounded-xl text-base font-medium shadow-lg hover:shadow-xl transition-all duration-300 group disabled:opacity-50"
                  >
                    {loading ? (
                      "Envoi en cours..."
                    ) : (
